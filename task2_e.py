...
# uncomment the instantiation of the Model with the hyperparameters and optimiser to test

# Using Stochastic Gradient Descent (SGD) with Momentum
# reminder: if no value for momentum is specified, the model uses 0.5 as default
...
# using 5000 epochs
model = Model(learning_rate=0.01, optimizer="sgd_momentum", epochs=5000) # optimal for SGD + Momentum using momentum 0.5

#model.momentum = 0.6 # test with 0.4, 0.5 & 0.6
